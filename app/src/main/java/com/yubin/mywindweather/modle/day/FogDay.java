...
/**
 * Created by YUBIN at 17-7-20 下午2:26
 * Last modified at 17-7-26 下午3:58
 */

public class FogDay extends Day {
    ...
    public void initDay(Context context) {
        ...
        bitmapSky=InitUtil.initFogSky(context,bitmapSky,true);
    ...
    public void initNight(Context context) {
        ...
        bitmapSky=InitUtil.initFogSky(context,bitmapSky,false);
