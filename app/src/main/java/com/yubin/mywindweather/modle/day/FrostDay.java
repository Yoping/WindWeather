...
/**
 * Created by YUBIN at 17-7-26 下午2:22
 * Last modified at 17-7-26 下午2:21
 */

public class FrostDay extends Day{
    ...
    public void initDay(Context context){
        ...
        bitmapSky=InitUtil.initFrostSky(context,bitmapSky,true);
    ...
    public void initNight(Context context){
        ...
        bitmapSky=InitUtil.initFrostSky(context,bitmapSky,false);
